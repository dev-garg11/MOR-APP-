...
export function EnquiryDetailModal({ visible, lead, onClose, onLeadUpdated }) {
  ...
  const handleWhatsApp = () => {
    ...
    const msg = `Hi ${lead.name}, this is the HR & Admissions team from Morph Academy regarding your enquiry for *${lead.course_interest || 'Creative Courses'}*. Are you available for a quick discussion?`;
